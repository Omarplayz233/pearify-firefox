@echo off
setlocal
echo welcome to pearifty builder!                                      
...
xcopy "%SOURCE_FOLDER%\logo" "%TEMP_FOLDER%\logo\" /E /Q
xcopy "%SOURCE_FOLDER%\fonts" "%TEMP_FOLDER%\fonts\" /E /Q
...
xcopy "%SOURCE_FOLDER%\logo" "%TEMP_FOLDER%\logo\" /E /Q
xcopy "%SOURCE_FOLDER%\icons" "%TEMP_FOLDER%\icons\" /E /Q
xcopy "%SOURCE_FOLDER%\fontss" "%TEMP_FOLDER%\fontss\" /E /Q
xcopy "%SOURCE_FOLDER%\icon.png" "%TEMP_FOLDER%"/Q
xcopy "%SOURCE_FOLDER%\settings.html" "%TEMP_FOLDER%"/Q
xcopy "%SOURCE_FOLDER%\settings.js" "%TEMP_FOLDER%"/Q
